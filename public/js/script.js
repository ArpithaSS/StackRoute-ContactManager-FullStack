...
function showContact(contacts) {
    ...
    <div class='col-sm-1 fw-bold'>Actions</div>
    `
    ...
    contacts.forEach(contact => {
        ...
        listRow.innerHTML = `
    <div class="col-1 border border-warning p-1 font-weight-bold"><span class=""></span> ${contact.id}</div>
      <div class="col-1 border border-warning p-1 font-weight-bold"><span class=""></span> ${contact.fname}</div>
...
async function addContact(event) {
    ...
    const newContact = {id, fname, lname, email, phone, age };
    try {
...
function editContact(contact) {
    ...
    // document.getElementById('editContactId').value = contact.fname;
    document.getElementById('editName').value = contact.fname;
...
async function updateContact(event) {
    ...
    const fname = document.getElementById('editName').value;
    const lname = document.getElementById('editLname').value;
    const email = document.getElementById('editEmail').value;
    const phone = document.getElementById('editPhone').value;
    const age = document.getElementById('editAge').value;
    const updateContact = { fname, lname, email, phone, age };
    try {
